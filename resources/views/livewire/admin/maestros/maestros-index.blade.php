<div wire:init="cargando">
    ...
    <a type="button" href="{{ route('maestros.crear') }}" class="float-right mb-3 btn btn-success">Agregar <i
        ...
        <tbody>
            @foreach ($maestros as $maestro)
                <tr>
                    ...
                    <td>
                        <a  href="{{ route('maestros.mostrar', $maestro) }}"  title="Ver más"
                            class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i></a>
                        <a  href="{{ route('maestros.editar', $maestro) }}"  title="Editar"
