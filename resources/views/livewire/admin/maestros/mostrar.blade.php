<div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-sm-4">
                <h3>{{ $maestro->id }}</h3>
                {{-- <h5>{{$maestro->apellidoPaterno}} {{$maestro->apellidoMaterno}}</h5> --}}
                <div class="fakeimg"><img class="card-img-top" {{-- width="80px" height="220px" --}}
                        src="{{ Storage::disk('public')->url($maestro->foto ? $maestro->foto : 'images/otros/maestros/defaultStudent.png') }}"
                        alt="Card image cap"></div>
                <p>Aqui va el boton para cambiar imagen</p>
                <hr class="d-sm-none">
            </div>
            <div class="col-sm-8">
                <h2>{{ $maestro->primerNombre }} {{ $maestro->segundoNombre }} {{ $maestro->apellidoPaterno }}
                    {{ $maestro->apellidoMaterno }}</h2>
