<div>
    ...
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-sm-4">
                <h3>{{ $usuario->primerNombre }}</h3>
                {{-- <h5>{{$alumno->apellidoPaterno}} {{$alumno->apellidoMaterno}}</h5> --}}
                <div class="fakeimg"><img class="card-img-top" {{-- width="80px" height="220px" --}}
                        src="{{ Storage::disk('public')->url($usuario->foto ? $usuario->foto : 'images/otros/usario/defaultStudent.png') }}"
                        alt="Card image cap"></div>
                <p>Aqui va el boton para cambiar imagen</p>
                <hr class="d-sm-none">
            </div>
            <div class="col-sm-8">
                <h2>{{ $usuario->segundoNombre }} {{ $usuario->segundoNombre }} {{ $usuario->apellidoPaterno }}
                    {{ $usuario->apellidopaterno }}</h2>
