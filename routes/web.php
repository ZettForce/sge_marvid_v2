...
use App\Http\Livewire\Maestro\Academico\CalificacionesIndex;
use App\Http\Livewire\Maestro\Academico\CalificacionesCreate;
...
Route::group(['middleware' => 'auth'],function(){
    ...
    //Rutas masestro
    Route::get('/maestros/calificaciones',CalificacionesIndex::class)->name('maestros.calificaciones.index');
    Route::get('/maestros/calificaciones/create',CalificacionesCreate::class)->name('maestros.calificaciones.create');
